...
# Source: https://nimara-demo.eu.saleor.cloud/graphql/
...
class AddressInput(BaseModel):
    ...
    skip_validation: Optional[bool] = Field(alias="skipValidation", default=None)
...
class OrderFilterInput(BaseModel):
    ...
    is_preorder: Optional[bool] = Field(alias="isPreorder", default=None)
    ids: Optional[List[str]] = None
    checkout_tokens: Optional[List[Any]] = Field(alias="checkoutTokens", default=None)
...
class OrderLineCreateInput(BaseModel):
    ...
    force_new_line: Optional[bool] = Field(alias="forceNewLine", default=None)
    price: Optional[Any] = None
...
class OrderFulfillInput(BaseModel):
    ...
    allow_stock_to_be_exceeded: Optional[bool] = Field(
        alias="allowStockToBeExceeded", default=None
    )
...
class OrderRefundProductsInput(BaseModel):
    ...
    include_shipping_costs: Optional[bool] = Field(
        alias="includeShippingCosts", default=None
    )
...
class OrderBulkCreateOrderLineInput(BaseModel):
    ...
    product_sku: Optional[str] = Field(alias="productSku", default=None)
    ...
    unit_discount_reason: Optional[str] = Field(
        alias="unitDiscountReason", default=None
    )
    unit_discount_type: Optional[DiscountValueTypeEnum] = Field(
        alias="unitDiscountType", default=None
    )
    unit_discount_value: Optional[Any] = Field(alias="unitDiscountValue", default=None)
    warehouse: str
    metadata: Optional[List["MetadataInput"]] = None
    private_metadata: Optional[List["MetadataInput"]] = Field(
        alias="privateMetadata", default=None
...
class CheckoutAddressValidationRules(BaseModel):
    check_required_fields: Optional[bool] = Field(
        alias="checkRequiredFields", default=None
    )
    check_fields_format: Optional[bool] = Field(alias="checkFieldsFormat", default=None)
    enable_fields_normalization: Optional[bool] = Field(
        alias="enableFieldsNormalization", default=None
    )
...
class PaymentInput(BaseModel):
    ...
    store_payment_method: Optional[StorePaymentMethodEnum] = Field(
        alias="storePaymentMethod", default=None
    )
    metadata: Optional[List["MetadataInput"]] = None
...
class CheckoutSettingsInput(BaseModel):
    ...
    automatically_complete_fully_paid_checkouts: Optional[bool] = Field(
        alias="automaticallyCompleteFullyPaidCheckouts", default=None
    )
...
class PaymentSettingsInput(BaseModel):
    ...
    release_funds_for_expired_checkouts: Optional[bool] = Field(
        alias="releaseFundsForExpiredCheckouts", default=None
    )
    checkout_ttl_before_releasing_funds: Optional[Any] = Field(
        alias="checkoutTtlBeforeReleasingFunds", default=None
    )
    checkout_release_funds_cut_off_date: Optional[Any] = Field(
        alias="checkoutReleaseFundsCutOffDate", default=None
    )
...
class AppInstallInput(BaseModel):
    ...
    activate_after_installation: Optional[bool] = Field(
        alias="activateAfterInstallation", default=None
    )
    permissions: Optional[List[PermissionEnum]] = None
